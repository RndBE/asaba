...
<?php
$qstatus=$this->db->query('select waktu from temp_rts where code_logger=30002 order by waktu desc ');
			...
			<div class="col-md-3 col-xxl-2"  id="target">
				<div class="row row-cards">
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								<div class="subheader"><label class="form-label">Pilih Pos ADR</label></div>
								<div class="h3 m-0"> 
									<?php  
									echo form_open('adr/set_pos');?>
									<select type="text" name="pilihpos" class="form-select" placeholder="Pilih Pos AWLR" onchange="this.form.submit()" id="select-pos" value=" ">
										...
										<option value="<?= $mnpos->idLogger ?>" <?= ($this->session->userdata('id_logger') == $mnpos->idLogger) ? 'selected' : '' ?>><?= str_replace('_', ' ', $mnpos->namaPos) ?></option>
										<?php endforeach ?>
									</select>
									<?php echo form_close() ?>
								</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									...
									<?php  
	echo form_open('adr/set_parameter2');?>
									<select type="text" name="mnsensor" class="form-select" placeholder="Pilih Parameter"  onchange="this.form.submit()"  id="select-parameter" value=" ">
										...
										<option value="<?= $mnparameter->idParameter ?>" <?= ($this->session->userdata('id_parameter') == $mnparameter->idParameter) ? 'selected' : '' ?>><?= str_replace('_', ' ', $mnparameter->namaParameter)?></option>
										<?php endforeach ?>
									</select>
									<?php echo form_close() ?>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<?php echo form_open('adr/sesi_data');?>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('adr/setbulan') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="input-icon">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('adr/settahun') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="input-icon">
									...
									<div class="offcanvas-body">
										<div>
											<table class="table table-sm table-borderless">
												<tbody>
													<?php 
													$query_informasi=$this->db->query('select * from t_informasi where logger_id="'.$this->session->userdata('id_logger').'"');
...
<script>
	...
	document.addEventListener("DOMContentLoaded", function () {
		...
		var el1;
		window.TomSelect && (new TomSelect(el1 = document.getElementById('select-parameter'), {
			controlInput: null,
		}));
	});
	// @formatter:on
