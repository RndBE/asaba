			...
			<div class="col-12 col-md">
				...
				<div class="row g-3 align-items-center justify-content-end">
					...
					<div class="col-6 col-md-auto d-flex">
						<a class="d-none d-lg-block btn w-100 me-3" href="<?= base_url() ?>masterdata/livedata">
							<!-- Download SVG icon from http://tabler-icons.io/i/settings -->
...
<div class="page-body">
	<div class="container-xl">
		<div class="row row-cards">
			<div class="col-md-4 col-xl-3 col-xxl-2"  id="target">
				<div class="row row-cards">
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0"> 
									<?php  
	echo form_open('masterdata/set_pos');?>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									...
									<?php  
	echo form_open('masterdata/set_parameter');?>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									...
									<?php echo form_open('masterdata/settgl') ;?>
									<div class="row">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<?php echo form_open('masterdata/sesi_data');?>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('masterdata/setbulan') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="input-icon">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('masterdata/settahun') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="input-icon">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="h3 m-0">
									<?php echo form_open('masterdata/setrange') ;?>
									<div class="row">
										<div class="col-12 col-md-12 col-sm-12">
											<div class="row">
												<div class="col-12 col-md-12 col-sm-12">
