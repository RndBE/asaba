...
<body class="text-bg-light px-3">
	<main>
		<h3 class="fw-bold mb-3 mt-3 text-center">Data Input AFMR</h3> 
				<hr/>
				...
				<div class="row gx-md-3 justify-content-center "> 
					<div class="col-lg-4"> 
						<ul class="list-group list-group-item-primary p-0">
							<li class="list-group-item d-flex justify-content-between align-items-center">
								...
								<span><?= $this->session->userdata('log_afmr') ?></span>
							</li>
							<li class="list-group-item d-flex justify-content-between align-items-center">
								<span class="fw-bold">Tanggal</span>
								<span><?= $this->session->userdata('tgl_afmr') ?></span>
							</li>
							<li class="list-group-item d-flex justify-content-between align-items-center">
					...
					<div class="col-lg-5 "> 
						<div class="card mb-2" >
							<div class="card-body ">
								<!--<form class="row g-3">-->
								<?php echo form_open('datamasuk/sesi_loggerafmr','class="row g-3 align-items-center "');?>
								<div class="col-3 ">
						...
						<div class="card mb-2">
							<div class="card-body justify-content-between align-items-center">
								<!--<form class="row g-3">-->
								<?php echo form_open('datamasuk/tgl_afmr','class="row g-3"');?>
								<div class="col-3">
					...
					<div class="col-lg-3 "> 
						<?php echo form_open('datamasuk/data_afmr');?>
	...
	<div class="container-fluid px-3">
		<div class="table-responsive">
			<table class="table table-sm table-bordered"> 
				...
				<tbody class="h6">
				<?php      
				foreach($data_afmr->result() as $row){
				?>
				<tr>
